...
/** Devuelve una copia del nombre del estado y agrega '->' o '*' si es 
 * inicial o final respectivamente */
char* estado_get_formatted_name(Estado * est);

/** Compara dos estados: devuelve 1 si son iguales y 0 en caso contrario */
